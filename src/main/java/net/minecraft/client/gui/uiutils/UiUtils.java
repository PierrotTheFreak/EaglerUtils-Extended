...
public class UiUtils {
    ...
    public static boolean mouseClicked(Screen screen,double mx,double my,int button){int x=(int)mx,y=(int)my;if(chatInput!=null&&isInside(x,y,CONTROL_X,getChatInputY(),CONTROL_WIDTH,CHAT_INPUT_HEIGHT)){chatInput.mouseClicked(mx,my,button);chatInput.setFocused(true);return true;}for(int i=0;i<BUTTON_NAMES.length;++i)if(isButtonHovered(x,y,i)&&button==0){handleButtonClick(screen,i);return true;}return false;}
    ...
    public static boolean keyPressed(Screen screen,int keyCode,int scanCode,int modifiers){return keyPressed(keyCode,scanCode,modifiers);}
    ...
    public static boolean charTyped(Screen screen,char codePoint,int modifiers){return charTyped(codePoint,modifiers);}
    ...
    public static void render(Screen screen,FontRenderer font,int mx,int my,float partialTicks){render(screen,mx,my,partialTicks);}
