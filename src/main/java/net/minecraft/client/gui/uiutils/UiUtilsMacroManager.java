...
public class UiUtilsMacroManager {
    ...
    public static void stopMacro(){if(runningMacro==null)return;UiUtilsPacketManager.clearDelayedPacketTypes();for(String packet:savedPacketTypes)UiUtilsPacketManager.setPacketDelayed(packet,true);runningMacro=null;actionIndex=-1;waitTicks=0;savedWaitForPackets=-1;savedPacketTypes.clear();}
